...
export const LOCALES: LocaleDef[] = [
  ...
  { code: 'de',    path: 'de',    label: 'Deutsch',    englishLabel: 'German',               dir: 'ltr', reviewed: true },
  { code: 'fr',    path: 'fr',    label: 'Français',   englishLabel: 'French',               dir: 'ltr', reviewed: true },
  { code: 'es',    path: 'es',    label: 'Español',    englishLabel: 'Spanish',              dir: 'ltr', reviewed: true },
  { code: 'it',    path: 'it',    label: 'Italiano',   englishLabel: 'Italian',              dir: 'ltr', reviewed: true },
  { code: 'pt-BR', path: 'pt-br', label: 'Português',  englishLabel: 'Portuguese (Brazil)',  dir: 'ltr', reviewed: true },
  { code: 'nl',    path: 'nl',    label: 'Nederlands', englishLabel: 'Dutch',                dir: 'ltr', reviewed: true },
  { code: 'ja',    path: 'ja',    label: '日本語',      englishLabel: 'Japanese',             dir: 'ltr', reviewed: true },
  { code: 'zh-CN', path: 'zh-cn', label: '简体中文',     englishLabel: 'Chinese (Simplified)', dir: 'ltr', reviewed: true },
  { code: 'ko',    path: 'ko',    label: '한국어',       englishLabel: 'Korean',               dir: 'ltr', reviewed: true },
  { code: 'sv',    path: 'sv',    label: 'Svenska',    englishLabel: 'Swedish',              dir: 'ltr', reviewed: true },
  { code: 'da',    path: 'da',    label: 'Dansk',      englishLabel: 'Danish',               dir: 'ltr', reviewed: true },
  { code: 'pl',    path: 'pl',    label: 'Polski',     englishLabel: 'Polish',               dir: 'ltr', reviewed: true },
  { code: 'nb',    path: 'nb',    label: 'Norsk',      englishLabel: 'Norwegian (Bokmål)',   dir: 'ltr', reviewed: true },
  { code: 'fi',    path: 'fi',    label: 'Suomi',      englishLabel: 'Finnish',              dir: 'ltr', reviewed: true },
];
